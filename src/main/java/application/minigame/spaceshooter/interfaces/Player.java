...
public interface Player {
    ...
    /**
     * I update the player. If it's exploding, I take the next sub-image until they finish.
     * The destroyed variable becomes true when I'm sure the sub-images they ended.
     */
    void update();
     ...
     * sub_images each line, I take 128px at a time, this.steps_img e
     * WIDTH / HEGHT 3) Then I draw this image in the position taken with getX / Y e
     * of size size.
     */
    void draw();
     ...
     */
    boolean touch(final Enemy enemy);
