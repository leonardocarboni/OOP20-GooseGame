...
public interface TTTView {
        ...
        /**
         * Draw an X, creating a random number and checking that index in the
         * list of buttons, if that value is "" then draw an X, otherwise do it again
         * the procedure.
         *
         * @param evt, to get the clicked button.
         * @param winCondition, check if I won.
         */
        void drawX(final Event evt, final Consumer<String> winCondition);
         ...
         * @param event
         */
        void releaseButton(final Event event);
